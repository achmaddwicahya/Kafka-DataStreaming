...
sensor_df = spark \
    ...
    .option("subscribe", "cahya-data-raw") \
    .option("startingOffsets", "earliest") \
    .option("kafka.security.protocol","SASL_SSL") \
    .option("kafka.sasl.mechanism", "PLAIN") \
    .option("kafka.sasl.username","P7EBHM5OUO7EC7OX") \
    .option("kafka.sasl.password", "dz+E/uSd2yFunDvIbMDiXdzmk5is2YGCR6JUfXYSZe9mGoL1x1GnVE+kvvQXcTmB") \
    .option("kafka.sasl.jaas.config", """org.apache.kafka.common.security.plain.PlainLoginModule required username="P7EBHM5OUO7EC7OX" password="dz+E/uSd2yFunDvIbMDiXdzmk5is2YGCR6JUfXYSZe9mGoL1x1GnVE+kvvQXcTmB";""") \
    .load()
