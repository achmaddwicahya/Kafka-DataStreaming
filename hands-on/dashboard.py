...
consumer = Consumer({'bootstrap.servers': 'pkc-ew3qg.asia-southeast2.gcp.confluent.cloud:9092', 'security.protocol': 'SASL_SSL', 'sasl.mechanisms': 'PLAIN', 'sasl.username': 'P7EBHM5OUO7EC7OX', 'sasl.password': 'dz+E/uSd2yFunDvIbMDiXdzmk5is2YGCR6JUfXYSZe9mGoL1x1GnVE+kvvQXcTmB', 'group.id': 'python_example_group_1', 'auto.offset.reset': 'earliest'})
# Set up a callback to handle the '--reset' flag.

# Subscribe to topic
consumer.subscribe(['cahya-data-clean'])
div = Div(
    text='',
    width=120,
    height=35
